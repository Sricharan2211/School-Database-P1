...
--Inserting Records on to the Subject Table
...
insert into Student values(1,'Manish','Kumar',1)
insert into Student values(2,'Arun','Kumar',2)
insert into Student values(3,'Sunil','Kumar',3)
insert into Student values(4,'Vijay','Kannan',4)
insert into Student values(5,'Sam','Dicosta',5)
insert into Student values(6,'Aditya','Arunachalam',1)
insert into Student values(7,'Kiran','Yadav',3)
insert into Student values(8,'Hari','Kiran',4)
insert into Student values(9,'Sri','Balaji',2)
insert into Student values(10,'Shali','Pandey',5)
